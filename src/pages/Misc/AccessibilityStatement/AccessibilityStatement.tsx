...
const AccessibilityStatement: FC = () => {
  return (
    <FooterPage title="Accessibility statement">
      ...
      <p>
        Contact us if you want to report an accessibility issue or if you need information on this
        website in a different format, like an accessible PDF or large print:
      </p>
      <ul>
      ...
      <p>
        We are committed to making this website as accessible as possible, in accordance with the
        Equality Act 2010.
      </p>
      <p>
        If you have contacted us about this website&apos;s accessibility and you are not happy with
        how we respond, contact the{' '}
      ...
      <p>
        Our accessibility roadmap will be published on this page when testing has taken place. This
        will show how and when we plan to improve accessibility on this website.
      </p>
      ...
      <p>
        ...
        Information on accessibility testing will be published on this page after testing has been
        carried out.
      </p>
    </FooterPage>
  );
